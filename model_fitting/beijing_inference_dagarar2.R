...
res2 = bayesspatempcensauto_ar2_fix(y = log(ytotobs),xtot = xtotobs,thetaini = thetaini,indicens = indicens3, iter = iter,burn = burn,thin = thin,lags = N_time_obs,
...
saveRDS(res2, paste0("ar2dagar_beijing_21_40000_",j,".rds"))
