...
1. To replicate results such as the CO concentratios application or some toy examples, you should install the auxiliarcpp package fron this repository. You can do this using the following line: 
...
** "prediction_graph_ar1dagar.R" . It contains the code to reproduce figure 21 (DAGAR prediction) of the supplementary material. The following archives are necessary to run this code. 
...
** "prediction_graph_car.R" . It contains the code to reproduce figure 4 (CAR prediction) of the supplementary material. The following archives are necessary to run this code. 
