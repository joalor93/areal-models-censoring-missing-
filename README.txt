...
To replicate results such as the CO concentratios application or some toy examples, you should install the auxiliarcpp package fron this repository. You can do this using the following line: 
